...
<div class="container">
	    ...
	    <div class="col-lg-3 col-md-4 col-xs-6 thumb">
			...
			<?php echo '<a class="thumbnail" href="'.site_url().'/album/details?album='.$row->idAlbum.'">';?>
	    	   
     		       <img class="img-responsive" src="<?php echo $row->Jacket;?>" alt=""/> 
...
<div class="pagination"><?php echo $liens;?></div>
